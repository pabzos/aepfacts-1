...
public class AepFactsDatabase {
    ...
    public AepFactsDatabase() {
        ...
        data.put("pablo", new MiniBiog("Pablo doesn't do much these days and likes windsurf and videogames.", "http://profile.ak.fbcdn.net/hprofile-ak-snc4/203393_585632745_7365858_q.jpg"));
